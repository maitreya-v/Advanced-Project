"""Build the 1990 age-32 validation reports without executing the graph."""
...
GRAPH = BASE.parent / "1990_32 yo.py"
...
methodology = {
    ...
    "age_scope": "Adult evidence was required for adult claims. The supplied papers study children or adolescents and were not transferred as causal proof for adults aged 32.",
...
readme = f"""# 1990 age-32 graph validation

Validation of **1990_32 yo.py**: **{len(edges)} edges**, using only the **four supplied PDF files** in `1990 ADHD Papers`.
