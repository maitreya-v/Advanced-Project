...
edges = [
    ...
    ("Neighborhood Quality", "Access to Mental Health Care", "+", 0.48, "Better neighborhood conditions modestly improve care access."),
    ...
    ("Race / Ethnicity", "Access to Mental Health Care", "-", 0.58, "Structural inequities reduce access for some groups."),
...
but stigma, cost, and misdiagnosis
...
filename = "1990_age_45_structural.html"
