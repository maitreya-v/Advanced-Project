...
("Genetic Risk","ADHD","+",0.9),

("ADHD","Symptom Severity","+",0.9),
("ADHD","Symptom Type","+",0.8),

("Symptom Severity","Functional Impairment","+",0.85),
("Functional Impairment","Comorbid Conditions","+",0.8),

("Comorbid Conditions","Family Stress","+",0.75),
("Family Stress","Symptom Severity","+",0.7),

("Family Stress","Household Stability","-",0.65),
("Household Stability","Family Stress","-",0.6),

("Socioeconomic Status","Access to Mental Health Care","+",0.8),
("Access to Mental Health Care","Provider Availability","+",0.85),

("Provider Availability","Diagnosis Status","+",0.9),
("Waiting Time for Assessment","Diagnosis Status","-",0.85),
("Cost of Evaluation","Diagnosis Status","-",0.8),

("Cultural Norms","Stigma","+",0.75),
("Stigma","Diagnosis Status","-",0.85),
...
Complex social and healthcare barriers
High family stress
Moderate stigma
Delayed but eventually successful diagnosis
""",
shape="box",
color="#f5f5f5",
physics=False
...
filename="adhd_persona5_causal_network.html"
