"""Build the 2010 age-32 validation reports without executing the graph."""
...
GRAPH = BASE.parent / "2010_32 yo.py"
...
methodology = {
    ...
    "age_scope": "Adult evidence was required for adult claims. Young-adult and general-adult evidence was treated as partial when it did not report an age-32 estimate. Pediatric findings were not transferred as adult causal proof.",
...
readme = f"""# 2010 age-32 graph validation

Validation of **2010_32 yo.py**: **{len(edges)} edges**, using only the **25 supplied PDF files (24 unique documents)** in `2010 ADHD Papers`.
