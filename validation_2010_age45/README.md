# 2010 age-45 graph validation

Validation of **2010_45 yo.py**: **61 edges**, using only the **25 supplied PDF files (24 unique documents)** in `2010 ADHD Papers`.
...
**Age Scope**: Adult evidence was required for adult claims. Young-adult and general-adult evidence was treated as partial when it did not report an age-45 or midlife estimate. Pediatric findings were not transferred as adult causal proof.
