...
node_cluster_map = {
    ...
    "Age": "individual",
    "Gender": "individual",
    "Genetic Risk": "individual",
    "Symptom Severity": "individual",
    "Symptom Type": "individual",
    "Comorbid Conditions": "individual",
    "Neurodevelopmental Risk": "individual",
    ...
    # School / Work
    "Teacher Referral Rate": "school_work",
    "Classroom Size": "school_work",
    "Academic Demands": "school_work",
    "School Resources": "school_work",
    "Workplace Accommodations": "school_work",

    # Healthcare
    "Access to Mental Health Care": "healthcare",
    "Provider Availability": "healthcare",
    "Diagnostic Criteria Variability": "healthcare",
    "Waiting Time for Assessment": "healthcare",
    "Cost of Evaluation": "healthcare",
    ...
    # Outcomes
    "Age at Diagnosis": "outcomes",
    "Misdiagnosis Rate": "outcomes",
    "Functional Impairment": "outcomes",
    "Quality of Life": "outcomes",

    # Prenatal / developmental
    "Prenatal Stress": "prenatal",
    "Maternal Nutrition": "prenatal",
    "Prenatal Substance Exposure": "prenatal",
    "Birth Complications": "prenatal",

    # Nutrition
    "Diet Quality": "nutrition",
    "Micronutrient Deficiency": "nutrition",
    "Ultra-Processed Food Intake": "nutrition",
    "Blood Sugar Instability": "nutrition",

    # Environment
    "Lead Exposure": "environment",
    "Air Pollution": "environment",
    "Environmental Toxins": "environment",
...
for node, (x, y) in node_positions.items():
    ...
    if node == "ADHD":
        ...
        cluster_name = node_cluster_map[node]
...
filename = "2026_clustered_light_colors.html"
